...
export CORE_PEER_TLS_ROOTCERT_FILE=/home/vakhim/Desktop/hyperledger3/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
export CORE_PEER_TLS_KEY_FILE=/home/vakhim/Desktop/hyperledger3/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/server.key
export CORE_PEER_TLS_CERT_FILE=/home/vakhim/Desktop/hyperledger3/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/server.crt
# export CORE_OPERATIONS_LISTENADDRESS=localhost:9445 


export CORE_LEDGER_STATE_STATEDATABASE=CouchDB
export CORE_LEDGER_STATE_COUCHDBCONFIG_COUCHDBADDRESS=localhost:5895
